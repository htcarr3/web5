...
Gem::Specification.new do |spec|
  ...
  spec.homepage = "https://github.com/htcarr3/web5."
  spec.license = "MIT"
  spec.required_ruby_version = ">= 2.6.0"

  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = "https://github.com/htcarr3/web5"
  spec.metadata["changelog_uri"] = "https://github.com/htcarr3/web5/blob/main/CHANGELOG.md"
